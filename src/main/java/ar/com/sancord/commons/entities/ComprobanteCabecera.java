...
//@XmlRootElement
//@NamedQueries({
//   @NamedQuery(name = "ComprobanteCabecera.findALL", query = "SELECT t FROM ComprobanteCabecera t")
// , @NamedQuery(name = "ComprobanteCabecera.findNCARGA", query = "SELECT t FROM ComprobanteCabecera t WHERE t.nCarga = :nCarga")})
